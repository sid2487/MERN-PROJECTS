...
export declare function parsePnpmLockfileVersion(version: unknown): SemVer | null;
export declare function readPnpmLockfile(lockfilePath: string): Promise<string | null>;
